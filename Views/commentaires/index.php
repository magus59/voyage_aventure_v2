...
<body>
    <nav>
        <ul id="ul_nav">
            <a href="../Accueil/index.php"><li id="li_nav">Accueil</li></a>
            <a href="../index.php"><li id="li_nav">Article</li></a>
            <a href="./index.php"><li id="li_nav">Commentaires</li></a>
        </ul>
    </nav>
        ...
        <?php if (!empty($commentaires)) : ?>
            <?php foreach ($commentaires as $commentaire) : ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($commentaire['likes']); ?></td>
                    <td>
                        ...
                        <a href="./index.php?controller=commentaire&action=like&id=<?php echo htmlspecialchars($commentaire['id']); ?>">Like</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php else : ?>
